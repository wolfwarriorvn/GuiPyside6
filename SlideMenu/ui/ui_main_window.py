...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_info = QLabel(self.hehe)
        self.lb_info.setObjectName(u"lb_info")
        font = QFont()
        font.setPointSize(48)
        font.setBold(True)
        self.lb_info.setFont(font)
        self.lb_info.setLayoutDirection(Qt.LeftToRight)
        self.lb_info.setStyleSheet(u"")
        self.lb_info.setAlignment(Qt.AlignCenter)

        self.verticalLayout.addWidget(self.lb_info)

        self.btn_test = QPushButton(self.hehe)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_info.setText(QCoreApplication.translate("MainWindow", u"HelloWorld", None))
        self.btn_test.setText(QCoreApplication.translate("MainWindow", u"Test Button", None))
